<script setup>
import InformationComponents from "../components/InformationComponents.vue"
import BestTicketsComponents from "../components/BestTicketsComponents.vue"
import DrawnNumbersComponents from "../components/DrawnNumbersComponents.vue"

</script>

<template>
  <main class="grid grid-cols-3 h-screen  gap-2 overflow-hidden w-[98%]">
    <InformationComponents />
    <BestTicketsComponents />
    <DrawnNumbersComponents />
  </main>
</template>
<style>
/* CSS */
...
ul.bolas-sena li .vazio {background: transparent;}
...
ul.cartelas li .cartela-box div.ativo {background: #cbeaad;}
ul.cartelas li .cartela-box div.vazio {background: #a1bad0;}
...
.modal.open .modal_content {transform: scale(1);}
.modal_body {margin: 2rem 0 0;}
...
.boxes {transition: transform 1s ease-in-out;}
.box {
	display: flex;
	justify-content: center;
	align-items: center;
